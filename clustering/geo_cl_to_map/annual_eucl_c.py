...
for year in range(2009,2022):
	df = pd.read_excel('../geo_cl_to_excel/results/'+str(year)+'_eucl_liv_c.xlsx',sheet_name=str(year))
	...
	if year == 2009:
		ax.scatter(932300,4215900, marker="s", color=colors[df['cluster'].loc[13]], alpha=0.7, zorder=5, s=50)
		ax.scatter(818800,4195100, marker="s", color=colors[df['cluster'].loc[15]], alpha=0.7, zorder=5, s=50)
		ax.scatter(1023100,4116700, marker="s", color=colors[df['cluster'].loc[22]], alpha=0.7, zorder=5, s=50)
	elif year == 2010:
		ax.scatter(927900,4172100, marker="s", color=colors[df['cluster'].loc[21]], alpha=0.7, zorder=5, s=50)
		ax.scatter(894300,4163600, marker="D", color=colors[df['cluster'].loc[3]], alpha=0.7, zorder=5, s=50)
		ax.scatter(857800,4175200, marker="D", color=colors[df['cluster'].loc[10]], alpha=0.7, zorder=5, s=50)
	elif year == 2011:
		ax.scatter(894300,4163600, marker="s", color=colors[df['cluster'].loc[3]], alpha=0.7, zorder=5, s=50)
		ax.scatter(1035600,4169000, marker="s", color=colors[df['cluster'].loc[8]], alpha=0.7, zorder=5, s=50)
		ax.scatter(1019400,4133900, marker="s", color=colors[df['cluster'].loc[12]], alpha=0.7, zorder=5, s=50)
		ax.scatter(955900, 4124800, marker="s", color=colors[df['cluster'].loc[30]], alpha=0.7, zorder=5, s=50)
	elif year == 2012:
		ax.scatter(1023100,4116700, marker="s", color=colors[df['cluster'].loc[22]], alpha=0.7, zorder=5, s=50)
	elif year == 2013:
		ax.scatter(1021100,4096400, marker="s", color=colors[df['cluster'].loc[18]], alpha=0.7, zorder=5, s=50)
	elif year == 2014:
		ax.scatter(962300,4177700, marker="s", color=colors[df['cluster'].loc[11]], alpha=0.7, zorder=5, s=50)
	elif year == 2015:
		ax.scatter(1009000,4283700, marker="s", color=colors[df['cluster'].loc[14]], alpha=0.7, zorder=5, s=50)
	elif year == 2017:
		ax.scatter(1038500,4181800, marker="s", color=colors[df['cluster'].loc[25]], alpha=0.7, zorder=5, s=50)
	elif year == 2018:
		ax.scatter(932300,4215900, marker="s", color=colors[df['cluster'].loc[13]], alpha=0.7, zorder=5, s=50)
		ax.scatter(1071800,4255800, marker="s", color=colors[df['cluster'].loc[16]], alpha=0.7, zorder=5, s=50)
		ax.scatter(971300,4188000, marker="D", color=colors[df['cluster'].loc[4]], alpha=0.7, zorder=5, s=50)
		ax.scatter(1000800,4210000, marker="D", color=colors[df['cluster'].loc[9]], alpha=0.7, zorder=5, s=50)
		ax.scatter(857800,4175200, marker="D", color=colors[df['cluster'].loc[10]], alpha=0.7, zorder=5, s=50)
		ax.scatter(927900,4172100, marker="D", color=colors[df['cluster'].loc[21]], alpha=0.7, zorder=5, s=50)
	elif year == 2019:
		ax.scatter(1043500,4142000, marker="s", color=colors[df['cluster'].loc[2]], alpha=0.7, zorder=5, s=50)
		ax.scatter(1038500,4181800, marker="s", color=colors[df['cluster'].loc[25]], alpha=0.7, zorder=5, s=50)
		ax.scatter(947900,4201500, marker="D", color=colors[df['cluster'].loc[27]], alpha=0.7, zorder=5, s=50)
	elif year == 2020:
		ax.scatter(990000,4141000, marker="s", color=colors[df['cluster'].loc[5]], alpha=0.7, zorder=5, s=50)
		ax.scatter(962300,4177700, marker="s", color=colors[df['cluster'].loc[11]], alpha=0.7, zorder=5, s=50)
	elif year == 2021:
		ax.scatter(857800,4175200, marker="s", color=colors[df['cluster'].loc[10]], alpha=0.7, zorder=5, s=50)
		ax.scatter(1007200,4147900, marker="D", color=colors[df['cluster'].loc[17]], alpha=0.7, zorder=5, s=50)
	
	for i, txt in enumerate(s):
		ax.text(x=x[i]-4000,y=y[i]-6000,s=txt, 
	          fontdict=dict(color='black',size=7))
	plt.savefig('results/eucl_clustering'+str(year)+'.png', dpi = 600)