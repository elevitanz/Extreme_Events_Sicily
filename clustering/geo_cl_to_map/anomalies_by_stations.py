...
colors=mcp.gen_color(cmap="hot",n=13)
...
ny = [0,0,9,4,2,2,0,0,6,1,5,4,1,2,2,1,7,2,4,0,2,2,6,2,2,11,0,1,2,0,1,1,6,1]
for i, txt in enumerate(s):
	ax.text(x=x[i]-4000,y=y[i]-6000,s=txt+':'+str(ny[i]), 
           fontdict=dict(color='black',size=7))
	ax.set_title('number of anomalies by station')
plt.savefig('results/final'+'.png', dpi = 200)