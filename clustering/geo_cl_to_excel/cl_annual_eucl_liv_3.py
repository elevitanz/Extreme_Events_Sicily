...
for j in range(len(years)):
	stats = ['agrigentomandrascava', 'alia','augusta', 'bivona', 'calascibetta',
	    'calatafimi', 'caltagirone', 'caltanissetta', 'canicatti', 'castellammare',
	    'catania', 'cesarovignazza', 'contessaentellina', 'enna', 'francofonte',
	    'lascari', 'leni', 'lentini', 'marsala', 'messina', 'mineo', 'modica',
	    'monrealebifarera', 'monrealevignaapi', 'mussomeli', 'palazzoloacreide',
	    'palermo', 'paterno','pedara', 'pettineo', 'polizzigenerosa', 'ragusa',
	    'ramaccagiumarra', 'randazzo', 'riesi', 'scicli','siracusa', 'trapanifontanasalsa']
	...
	if j == 0: #2009
	    ...
	    'monrealebifarera', 'palazzoloacreide',
		...
		stats = ['agrigentomandrascava', 'alia', 'bivona', 'calascibetta',
	    'caltagirone', 'caltanissetta', 'canicatti',
	    'catania', 'cesarovignazza', 'francofonte',
		...
		stats = ['agrigentomandrascava', 'alia','bivona',
		...
		stats = ['agrigentomandrascava', 'alia', 'bivona', 'calascibetta',
	    'caltagirone', 'caltanissetta', 'canicatti',
	    'cesarovignazza', 'enna', 'francofonte',
	    'lascari', 'leni', 'marsala', 'messina', 'mineo', 'modica',
	    'monrealebifarera', 'monrealevignaapi', 'mussomeli', 'palazzoloacreide',
	    'palermo', 'paterno','pedara', 'pettineo', 'polizzigenerosa', 'ragusa',
	    'ramaccagiumarra', 'riesi', 'scicli', 'trapanifontanasalsa']
	...
	print(data['cluster'])
	data['cluster'].to_excel('results/'+years[j]+'_eucl_liv_3.xlsx', sheet_name=years[j])
