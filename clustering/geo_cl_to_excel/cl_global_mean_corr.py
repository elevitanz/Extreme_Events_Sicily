...
directory = os.fsencode('../mean_stations/')
...
files = {}
for stat in stats:
	files[stat] = pd.read_csv('../mean_stations/'+ stat, delimiter = ";")
...
print(data['cluster'])
data['cluster'].to_excel('results/global_mean_corr.xlsx', sheet_name='global')