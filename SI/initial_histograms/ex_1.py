...
for i in range(len(df_tot)):
    if df_tot[i]['Stazione'].unique() == 'Messina':
        c = i
    if df_tot[i]['Stazione'].unique() == 'Trapani Fontanasalsa':
        p = i
...
ax[0,1].set_title('Messina')
#ax[0,2].set_title('maximum')

#ax[1,0].set_title('total')
ax[1,1].set_title('Trapani Fontanasalsa')
