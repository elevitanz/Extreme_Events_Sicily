...
###DON'T USE LEAP YEARS (2012 2016 2020) WITH THIS SCRIPT ###
file = pd.read_csv('../stations/augusta2021.txt', delimiter = ";")
...
months = [0, 4464, 8496, 12960, 17280, 21744, 26064, 30528, 34992, 39312, 43776, 48096, 52560] 
df_months = []
